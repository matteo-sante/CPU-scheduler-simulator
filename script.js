...
let p = ["P1", "P2", "P3", "P4"]; //ARRAY PROCESSI
let at = [4, 1, 3, 2]; //ARRAY TEMPO DI ARRIVO
let bt = [2, 3, 4, 5]; //ARRAY TEMPO DI BURST
let rbt = [2, 3, 4, 5]; //ARRAY TEMPO DI BURST RIMANENTE
let pr = ["not needed", "not needed", "not needed", "not needed"]; //ARRAY PRIORITÀ
